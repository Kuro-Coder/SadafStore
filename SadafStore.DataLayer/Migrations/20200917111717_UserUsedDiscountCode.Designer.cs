...
namespace SadafStore.DataLayer.Migrations
{
    ...
    [Migration("20200917111717_UserUsedDiscountCode")]
    partial class UserUsedDiscountCode
    {
            ...
            modelBuilder.Entity("SadafStore.DataLayer.Entities.User.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            ActiveCode = "1767c92b-1bec-4af9-9601-72aed92ed5f1",
                            ...
                            RegisterDate = new DateTime(2020, 9, 17, 15, 47, 16, 69, DateTimeKind.Local).AddTicks(7001),
                            UserName = "Habib"
                        });
                });
